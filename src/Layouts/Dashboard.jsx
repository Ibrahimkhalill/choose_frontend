  ...
  return (
    <div className="flex h-screen bg-white text-black overflow-hidden">
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-20 p-2 bg-[#89540E] text-white rounded-lg hover:bg-[#6B3D01] transition-colors">
        <RiMenu3Line size={24} />
      </button>
      ...
      <aside
              ...
              <Link
                ...
                className={`flex items-center gap-4 px-4 py-3 rounded-lg transition-all duration-200 group ${
                  location.pathname === Menu.path
                    ? "bg-[#89540E] text-white shadow-md"
                    : "text-gray-700 hover:bg-[#89540E]/10"
                }`}>
        ...
        <div className="p-4 md:p-6 border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center gap-4 px-4 py-3 text-gray-700 hover:bg-[#89540E]/10 hover:text-black cursor-pointer rounded-lg transition-colors duration-200">
        ...
        <header className="bg-white border-b border-gray-200 pt-16 md:pt-0">
          <div className="h-16 md:h-20 px-4 md:px-8 flex items-center justify-between">
            ...
            <Link
              ...
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden flex-shrink-0 border-2 border-[#89540E]">
                <img
