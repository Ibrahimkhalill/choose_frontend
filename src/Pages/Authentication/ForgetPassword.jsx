          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 mt-2 rounded-lg border border-[#B0B0B0] outline-none focus:ring-2 focus:ring-[#F3EEE7] text-sm sm:text-base"
              />
              {errors.email && (
            ...
            <button
              type="submit"
              className="w-full bg-[#89540E] text-white py-2 rounded-lg cursor-pointer hover:bg-[#744303] focus:outline-none focus:ring-2 focus:ring-[#F3EEE7] disabled:bg-[#A67C00]/60 text-sm sm:text-base"
              disabled={isLoading}>
