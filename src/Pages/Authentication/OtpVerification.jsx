      ...
      <div className="flex items-center justify-center w-full max-w-md sm:max-w-lg  bg-white rounded-lg shadow-md p-6 sm:p-8 lg:p-10">
        <div className="w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex justify-start gap-2 sm:gap-4">
              {[0, 1, 2, 3, 4, 5].map((index) => (
                <input
                  ...
                  className="w-12 sm:w-14 h-12 sm:h-14 text-center  bg-[#F3EEE7] rounded-lg text-lg sm:text-xl focus:outline-none  focus:ring-[#F3EEE7]"
                />
              ))}
            </div>

            <p className="text-right mr-5 text-xs sm:text-sm mt-4">
              <button
                type="button"
            ...
            <button
              type="submit"
              className="w-full bg-[#89540E] text-white py-2 rounded-full hover:bg-[#744303] focus:outline-none focus:ring-2 focus:ring-[#F3EEE7] disabled:bg-[#A67C00]/60 text-sm sm:text-base"
              disabled={isLoading}>
