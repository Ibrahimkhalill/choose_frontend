          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input
                ...
                } outline-none focus:ring-2 focus:ring-[#F3EEE7] text-sm sm:text-base`}
              />
              {errors.password && (
            ...
            <button
              type="submit"
              className="w-full bg-[#89540E] text-white py-2 rounded-lg hover:bg-[#744303] focus:outline-none focus:ring-2 focus:ring-[#F3EEE7] cursor-pointer text-sm sm:text-base"
