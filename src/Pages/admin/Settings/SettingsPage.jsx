        ...
        <form onSubmit={handleSaveAccountChanges} className="space-y-6">
          ...
          <div className="flex justify-end pt-6">
            <button
              ...
              className="px-6 py-2 sm:py-3 bg-[#89540E] hover:bg-[#926427] cursor-pointer disabled:bg-[#89540E] disabled:opacity-50 text-white font-semibold rounded-lg transition-colors text-sm sm:text-base">
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#89540E] text-sm sm:text-base pr-12 ${
