      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border  border-gray-100">
          ...
          <div className="p-4 md:p-6 text-center border-t border-gray-200">
            <button className="text-[#89540E] hover:text-orange-700 font-semibold text-sm md:text-base transition-colors">
              View More
            </button>
          </div>
        </div>
            ...
            {leaderboard.map((item, idx) => (
              <div
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="ml-4 w-10 h-10 md:w-12 md:h-12 bg-[#89540E] text-white rounded-lg flex items-center justify-center font-bold text-sm md:text-base">
                    {item.rank}
                  </div>
                </div>
              </div>
