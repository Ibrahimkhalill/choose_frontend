            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart
                ...
                <XAxis
                  ...
                  style={{ fontSize: "12px" }}
                />
                <YAxis stroke="#89540E" style={{ fontSize: "12px" }} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: "#fff",
                    border: "1px solid #89540E",
                    borderRadius: "8px",
                    fontSize: "12px",
                  }}
          ...
          <div className="w-full h-64 md:h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                ...
                />
                <Bar dataKey="orders" fill="#89540E" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
          ...
          <div className="space-y-4">
            {topSellingItems.map((item, idx) => (
              <div
                ...
                <div className="w-10 h-10 md:w-12 md:h-12 bg-[#89540E] text-white rounded-lg flex items-center justify-center font-bold text-sm md:text-base flex-shrink-0">
                  {item.rank}
                </div>
            ...
            {peakHoursData.map((hour, idx) => (
              <div key={idx} className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <p className="text-sm font-bold text-[#89540E]">
                    {hour.revenue}
                  </p>
                </div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className="bg-[#89540E] h-2 rounded-full transition-all duration-300"
