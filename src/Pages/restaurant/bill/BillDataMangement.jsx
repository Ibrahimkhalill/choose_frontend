        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center justify-between">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#89540E] text-sm sm:text-base"
            />
          </div>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 sm:py-3 bg-[#89540E] hover:bg-amber-800 text-white rounded-lg transition-colors font-semibold text-sm sm:text-base whitespace-nowrap">
            <Plus size={20} />
            <span>Add Bill</span>
          </button>
        </div>
          ...
          <div className="hidden md:block overflow-y-auto h-[40vh] ">
            <table className="w-full">
              <thead className="bg-amber-50">
                <tr>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-[#89540E]">
                    QR Number
                  </th>
                  <th className="px-6 py-3 text-left text-sm font-semibold text-[#89540E]">
                    Order Number
