    ...
    <div className="p-3 sm:p-4">
      ...
      <div className="flex gap-2 sm:gap-3">
        <button
          ...
          className="flex-1 flex items-center cursor-pointer  justify-center gap-2 px-2 sm:px-3 py-1.5 sm:py-2 border border-[#89540E] text-[#89540E] rounded-lg hover:bg-amber-50 transition-colors text-xs sm:text-sm font-semibold">
