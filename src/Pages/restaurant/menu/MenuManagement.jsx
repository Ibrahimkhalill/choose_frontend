      ...
      <div className="w-full space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center justify-between">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2 sm:py-3 bg-[#89540E] hover:bg-[#926427] cursor-pointer text-white rounded-lg transition-colors font-semibold text-sm sm:text-base whitespace-nowrap">
            <Plus size={20} />
