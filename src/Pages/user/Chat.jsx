                    ...
                    <div className="max-w-xl">
                      ...
                      {message.type === "user" ? (
                        <div className="flex flex-col items-end space-y-3">
                          ...
                          {message.text && (
                            <div className="px-6 py-4 rounded-2xl rounded-tr-none bg-[#89540E] text-white text-base shadow-lg">
                              {message.text}
                            </div>
                          )}
                        </div>
                          ...
                          {message.hasCard && message.restaurant && (
                            <div className="bg-white rounded-2xl overflow-hidden border border-stone-200 shadow-xl hover:shadow-2xl transition-all">
                              ...
                              <div className="p-6 space-y-5">
                                ...
                                <button className="w-full py-4 bg-[#89540E] hover:bg-[#A16414] text-white font-bold rounded-xl transition transform hover:scale-105 shadow-lg">
          ...
          <div className="max-w-5xl mx-auto p-4 relative">
            ...
            <div className="flex items-center px-2 gap-3 bg-white border border-stone-300 rounded-full shadow-lg">
              ...
              <button
                ...
                className="p-2 text-stone-600 hover:text-[#89540E] hover:bg-stone-100 rounded-full transition"
                title="Upload image">
                <Plus size={22} />
              </button>
                ...
                className={`
                  ...
                  ${
                    inputText.trim() || previewImage
                      ? "bg-[#89540E] text-white hover:bg-[#BC7A24] shadow-md"
