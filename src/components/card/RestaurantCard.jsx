...
const RestaurantCard = ({ restaurant, setIsOpen }) => (
  <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow h-full flex flex-col">
    ...
    <div className="relative w-full h-40 sm:h-48 overflow-hidden bg-gray-200">
      ...
      />
      {restaurant.discount && (
        <div className="absolute top-2 right-2 bg-[#89540E] text-white text-xs sm:text-sm font-bold px-2 py-1 rounded">
          {restaurant.discount}
        </div>
      )}
    </div>
    ...
    <div className="p-3 sm:p-4 flex flex-col flex-1">
      ...
      <button
        ...
        className="w-full mt-auto py-2 px-3 bg-[#89540E] hover:bg-[#7D4C0D] text-white text-xs sm:text-sm font-semibold rounded-lg transition-colors flex items-center justify-center gap-1">
