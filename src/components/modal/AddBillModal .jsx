          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#89540E] text-sm sm:text-base ${
                  ...
                  <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-300 rounded-lg shadow-lg z-10 max-h-48 overflow-y-auto">
                    {filteredItems.map((item) => (
                      <button
                        ...
                        <Plus size={18} className="text-[#89540E]" />
                      </button>
                    ))}
                  </div>
                )}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    step="0.01"
                    min="0"
                    className={`w-full pl-8 pr-4 py-2 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#89540E] text-sm sm:text-base ${
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#89540E] hover:bg-[#A16414] disabled:bg-[#89540E] disabled:opacity-50 text-white font-semibold py-2 sm:py-3 rounded-lg transition-colors text-sm sm:text-base">
