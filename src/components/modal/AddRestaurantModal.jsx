          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <label
                  htmlFor="logo-upload"
                  className="flex flex-col items-center justify-center w-full p-6 sm:p-8 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#89540E] hover:bg-[#F2EDE6] transition-colors">
                  {preview ? (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#89540E] hover:bg-amber-800 disabled:bg-[#89540E] disabled:opacity-50 text-white font-semibold py-2 sm:py-3 rounded-lg transition-colors text-sm sm:text-base">
