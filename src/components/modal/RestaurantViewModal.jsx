    ...
    <>
      {!isModalOpen ? (
        <div className="fixed inset-0 bg-black/50  flex items-center justify-center p-4 z-50">
          <div
            className="bg-white px-3 rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl"
            ref={dropdownRef}>
            {/* Header */}
            ...
            {/* QR Code Section */}
            <div className="px-6 shadow py-3 border border-gray-50 rounded-xl flex flex-col items-center">
              ...
              <button className=" bg-yellow-600 hover:bg-yellow-700 text-white font-semibold py-2.5 cursor-pointer px-6 rounded-lg transition-colors">
                Claim QR Code
              </button>
            </div>
            <div
              onClick={() => setIsModalOpen(true)}
              className="px-6 pb-4 w-full flex items-center justify-center">
              <button className=" mt-5 bg-yellow-600 hover:bg-yellow-700 text-white font-semibold py-2.5 px-6 cursor-pointer rounded-lg transition-colors">
                Leave a Review
              </button>
            </div>
          </div>
